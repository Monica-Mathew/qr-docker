...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. [https://github.com/Monica-Mathew](https://github.com/Monica-Mathew)
...
![QR Code Image](qr_codes_package/QRCode_20250402030010.png)

2.  Add an image of viewing the log of successfully creating the QR code below.
![QR Code Docker Logs](qr_code_docker_logs.png)
